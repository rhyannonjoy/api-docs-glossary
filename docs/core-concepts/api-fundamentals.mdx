...
[API endpoint](#api-endpoint), [API gateway](../api-types-architectures.mdx#api-gateway),
[API security](#api-security),
[CLI](../tools-techniques/development-essentials.mdx#cli),
...
[troubleshooting](documentation-specific.mdx#troubleshooting), [validation](#validation)
...
[AsyncAPI](documentation-specific.mdx#asyncapi), [error-handling](#error-handling),
[HTTPS](#https), [HTTP status codes](#http-status-codes),
[HTTP versions](#http-versions), [REST API](../api-types-architectures.mdx#rest-api)
...
[request-response](#request-response), [REST API](../api-types-architectures.mdx#rest-api),
[troubleshooting](documentation-specific.mdx#troubleshooting), [validation](#validation)
...
**Related Terms**: [gRPC API](../api-types-architectures.mdx#grpc-api),
...
**Related Terms**: [JSON-RPC](../api-types-architectures.mdx#json-rpc),
[payload](#payload), [REST API](../api-types-architectures.mdx#rest-api),
[serialization](#serialization),
[XML](../tools-techniques/development-essentials.mdx#xml),
...
**Related Terms**: [AMQP](../api-types-architectures.mdx#amqp), [API](#api),
[AsyncAPI](documentation-specific.mdx#asyncapi),
[event-driven](../api-types-architectures.mdx#event-driven),
[Kafka](../tools-techniques/infrastructure-platforms.mdx#kafka),
...
[request-response](#request-response), [REST API](../api-types-architectures.mdx#rest-api),
[serialization](#serialization), [XML](../tools-techniques/development-essentials.mdx#xml)
...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-request-response-cycle.png" 
...
[HTTP method](#http-method), [REST API](../api-types-architectures.mdx#rest-api),
[URI](#uri), [URL](#url)
...
[OpenAPI specification](documentation-specific.mdx#openapi-specification),
...
**Related Terms**: [API](#api),
[cURL](../tools-techniques/development-essentials.mdx#curl),
[developer portal](../tools-techniques/documentation-specific.mdx#developer-portal),
[Fern](../tools-techniques/documentation-specific.mdx#fern),
[OpenAPI Specification](documentation-specific.mdx#openapi-specification),
[REST API](../api-types-architectures.mdx#rest-api),
...
[Protocol Buffers](../tools-techniques/development-essentials.mdx#protocol-buffers),
[XML](../tools-techniques/development-essentials.mdx#xml),
[YAML](../tools-techniques/development-essentials.mdx#yaml)
...
[REST API](../api-types-architectures.mdx#rest-api), [URL](#url)
...
[REST API](api-types-architectures.mdx#rest-api), [schema](#schema), [URI](#uri)
...
primarily a core data handling concept, validation can also prevent
