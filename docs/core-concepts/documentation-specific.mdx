...
[REST vs *REST*ful](../api-types-architectures.mdx#rest-vs-restful),
[YAML](../tools-techniques/development-essentials.mdx#yaml)
...
**Purpose**: serves developers who need to look up specific API details quickly
and return to their work; reference topics function as the API's memory —
capturing endpoint signatures, parameter types, response shapes, and available
operations so developers don't need to hold those details themselves; in API
docs contexts, reference topics also support pre-adoption research, giving
evaluators the technical specifics they need to assess whether an API
fits their integration requirements

**Core Components**

| Aspect | Details |
|---|---|
| **Common Use Cases** | **Not aware of API** — readers researching new options or products; **Aware of API** — readers looking for more specific information |
| **Reader's Goals** | Become aware of the product; learn more about the product; navigate to other docs about the product |
| **Key Characteristics** | A value proposition, a tagline; CTAs, as in "Get Started," "Contact Us," and/or "Learn More"; links to common destinations such as "Docs," "FAQ," "Reference," and/or "Support" |
| **Design Considerations** | Examine the audience and their goals across many users, use cases, and goals; ask _"might adding or removing this content help the reader achieve their goal?"_ - determine how visual design and branding might be significant |
...
**Related Terms**: [API reference topic](#api-reference-topic), [CTA](../writing-style.mdx#cta),
[getting started](#getting-started), [introduction](#introduction), [market](../frameworks-strategy.mdx#market),
[sales collateral](../frameworks-strategy.mdx#sales-collateral), [top-level](#top-level)
...
**Related Terms**: [AMQP](../api-types-architectures.mdx#amqp),
...
[HTTP](api-fundamentals.mdx#http), [Kafka](../tools-techniques/infrastructure-platforms.mdx#kafka),
[Mercure](../api-types-architectures.mdx#mercure),
[MQTT](../api-types-architectures.mdx#mqtt),
[OpenAPI Specification](#openapi-specification),
[REST API](../api-types-architectures.mdx#rest-api),
[STOMP](../api-types-architectures.mdx#stomp),
[WebSocket API](../api-types-architectures.mdx#websocket-api),
[YAML](../tools-techniques/development-essentials.mdx#yaml)
...
**Related Terms**: [concept](#concept), [Diátaxis](frameworks-strategy.mdx#diátaxis),
...
**Related Terms**: [Diátaxis](frameworks-strategy.mdx#diátaxis),
...
[API Docs Glossary: "Introduction"](../introduction.mdx)
...
[reference](#reference), [REST API](../api-types-architectures.mdx#rest-api),
...
[API sandbox](../tools-techniques/documentation-specific.mdx#api-sandbox),
[concept](#concept), [developer portal](../tools-techniques/documentation-specific.mdx#developer-portal),
[Diátaxis](frameworks-strategy.mdx#diátaxis), [explanation guide](#explanation-guide),
...
**Related Terms**: [API sandbox](../tools-techniques/documentation-specific.mdx#api-sandbox),
[concept](#concept), [developer portal](../tools-techniques/documentation-specific.mdx#developer-portal),
[Diátaxis](frameworks-strategy.mdx#diátaxis), [getting started](#getting-started),
