...
- [Apache Software Foundation, Docs: "Apache Kafka is an event streaming platform. What does that mean?"](https://kafka.apache.org/41/getting-started/introduction/#apache-kafka-is-an-event-streaming-platform-what-does-that-mean)
...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-linear-workflow.png" 
  alt="Flowchart showing steps: docs team uses Linear to track tasks, dev commits changes, Linear moves ticket, docs work stays synced with development"
/>
...
[Falconer](documentation-specific.mdx#falconer),
[Git](development-essentials.mdx#git),
[GitHub](development-essentials.mdx#github),
