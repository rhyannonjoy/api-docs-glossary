...
[BDD](#bdd), [contract testing](#contract-testing), [Doc Detective](./tools-techniques/testing-validation.md#doc-detective),
[docs observability](frameworks-strategy.mdx#docs-observability), [docs theater](writing-style.mdx#docs-theater),
[self-healing system](frameworks-strategy.mdx#self-healing-system), [snippet testing](#snippet-testing),
