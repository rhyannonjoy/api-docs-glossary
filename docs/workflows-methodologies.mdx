...
**Related Terms**: [Agile](#agile), [CMS](./tools-techniques/documentation-specific.mdx#cms),
[diagrams-as-code](#diagrams-as-code), [docs-as-ecosystem](frameworks-strategy.mdx#docs-as-ecosystem),
[docs observability](frameworks-strategy.mdx#docs-observability), [Git](./tools-techniques/development-essentials.mdx#git),
[GitHub](./tools-techniques/development-essentials.mdx#github), [`main` branch](./tools-techniques/development-essentials.mdx#main-branch),
[MDX](./tools-techniques/documentation-specific.mdx#mdx), [metaprogramming](ai-and-apis.mdx#metaprogramming),
[pull request](./tools-techniques/development-essentials.mdx#pull-request), [self-healing system](frameworks-strategy.mdx#self-healing-system),
[version control](./tools-techniques/development-essentials.mdx#version-control)
...
[docs observability](frameworks-strategy.mdx#docs-observability), [docs theater](writing-style.mdx#docs-theater), [eval](ai-and-apis.mdx#eval),
[probabilistic testing](#probabilistic-testing), [self-healing system](frameworks-strategy.mdx#self-healing-system), [snippet testing](#snippet-testing),
