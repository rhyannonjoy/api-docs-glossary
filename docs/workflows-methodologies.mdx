...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-workflows-methodologies.png" 
  alt="Flowchart showing the relationship between workflow phases analysis and planning, design, content development, review and edit, publish, maintain"
/>
...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-agile-workflow.png" 
  alt="Flowchart showing Agile key values of people over processes, working solutions over details docs, customer collaboration over rigid contracts, and adapting to change over following a strict plan"
/>
...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-api-docs-testing.png" 
  alt="Flowchart showing an API docs testing workflow including test implementation, running tests, endpoint changes, tests failing, tests alerting team to change docs"
/>

**Related Terms**: [AI agent](ai-and-apis.mdx#ai-agent), [API](./core-concepts/api-fundamentals.mdx#api),
[API sandbox](./tools-techniques/documentation-specific.mdx#api-sandbox), [BDD](#bdd), [Bruno](./tools-techniques/testing-validation.md#bruno), [contract testing](#contract-testing),
[Cypress](./tools-techniques/testing-validation.md#cypress), [deterministic testing](#deterministic-testing), [Doc Detective](./tools-techniques/testing-validation.md#doc-detective),
[docs-as-tests](#docs-as-tests), [HTTP status codes](./core-concepts/api-fundamentals.mdx#http-status-codes), [Playwright](./tools-techniques/testing-validation.md#playwright),
[probabilistic testing](#probabilistic-testing), [REST API](api-types-architectures.mdx#rest-api), [self-healing system](frameworks-strategy.mdx#self-healing-system),
[UX](frameworks-strategy.mdx#ux), [workflow testing](#workflow-testing)
...
[Vale](./tools-techniques/documentation-specific.mdx#vale),
...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-critical-path-method.png" 
  alt="Flowchart showing Critical Path Method example steps: code freeze, QA testing, docs review, deployment"
/>
...
**Definition**: testing approach that produces the same result every time
given the same inputs; a test either passes or fails based on fixed,
objective criteria with no variation between runs

**Purpose**: provides reliable, repeatable signals in docs workflows — if
a test fails, something in the environment changed, not the test itself;
are the foundation of [CI/CD docs pipelines](./tools-techniques/development-essentials.mdx#cicd-pipeline)
because teams can trust their results without needing to run them multiple
times or aggregate results

**Why this belongs in `Workflows & Methodologies`**: describes a testing
methodology and workflow practice applicable across docs contexts, not only
AI systems; deterministic testing applies to traditional doc testing tools
like [Doc Detective](./tools-techniques/testing-validation.md#doc-detective)
verifying [UI](./tools-techniques/development-essentials.mdx#ui) procedures,
API [contract testing](#contract-testing), and code-based
[eval graders](ai-and-apis.mdx#eval); it describes _how teams test_, making it
a methodology concept rather than an AI-specific concept

### deterministic vs probabilistic

| | **Deterministic Testing** | **Probabilistic Testing** |
| --- | --- | --- |
| **Consistency** | Same result every run | Output varies between runs |
| **Signal** | Pass or fail | Requires multiple trials and result aggregation |
| **Examples** | CI checks, Doc Detective, Vale style rules | Browser-use agents, LLM-as-judge graders |
| **Upfront Investment** | Higher | Lower |
| **Scales in CI/CD** | Cost-effectively | Gets expensive fast |

**Example**: a tech writer configures Doc Detective to verify a REST API quickstart
guide on every pull request; the test opens a browser, navigates to the developer
portal, runs each documented CLI command, and compares screenshots against baseline
images; if a UI button moves or an API parameter changes, the CI check fails
deterministically — the same inputs always produce the same result, so a failure
means something in the product changed, not that the test ran differently

**Related Terms**: [API documentation testing](#api-documentation-testing), [CI/CD pipeline](./tools-techniques/development-essentials.mdx#cicd-pipeline),
[contract testing](#contract-testing), [docs-as-tests](#docs-as-tests), [eval](ai-and-apis.mdx#eval), [probabilistic testing](#probabilistic-testing)

**Sources**:

- [Anthropic PBC, Engineering at Anthropic: "Demystifying evals for AI agents"](https://www.anthropic.com/engineering/demystifying-evals-for-ai-agents)
- [I'd Rather Be Writing: "Podcast: Doc testing, skills files, and the guardians of knowledge – with Manny Silva" by Tom Johnson, Fabrizio Ferri-Benedetti](https://idratherbewriting.com/blog/podcast-silva-guardians-of-knowledge)
...
**Related Terms**: [accessibility](frameworks-strategy.mdx#accessibility),
[D2](./tools-techniques/diagramming-visualization.mdx#d2),
[diagram](./tools-techniques/diagramming-visualization.mdx#diagram),
[docs-as-code](#docs-as-code), [GUI](./tools-techniques/development-essentials.mdx#gui),
[Ilograph](./tools-techniques/diagramming-visualization.mdx#ilograph),
[Large Language Model](ai-and-apis.mdx#large-language-model),
[Mermaid](./tools-techniques/diagramming-visualization.mdx#mermaid),
[PlantUML](./tools-techniques/diagramming-visualization.mdx#plantuml),
[pull request](./tools-techniques/development-essentials.mdx#pull-request),
[Python Diagrams](./tools-techniques/diagramming-visualization.mdx#python-diagrams),
[UML](./tools-techniques/diagramming-visualization.mdx#uml),
[version control](./tools-techniques/development-essentials.mdx#version-control)
...
or [Swagger](./tools-techniques/documentation-specific.mdx#swagger)

**Example** docs-as-code workflow:

<ZoomImage 
  src="/api-docs-glossary/img/flowchart-docs-as-code-workflow.png" 
  alt="Flowchart showing docs-as-code workflow: store docs in Git, GitHub tracks changes, review changes, test changes, deploy-merge changes"
/>

| **Benefits** | **Considerations** |
|---|---|
| **Transparency** — all discussions, decisions, and changes visible in one place | **Learning Curve** - requires all contributors to learn the version control system and toolchain |
| **Collaboration** — developers draft, writers refine, everyone contributes | **Formality** - may limit spontaneous collaboration if team relies solely on formal issue tracking |
| **Traceability** — complete history of what changed and why, accessible years later | **Process Dependency** - effectiveness depends on comprehensive testing and review processes |
| **Efficiency** — eliminates context-switching, reduces time searching email or chat | **Comm Standards** - demands clear communication standards for asynchronous, distributed teams |
| **Integration** — documentation stays synchronized with code through the same review process | **Standardization Balance** - success requires balancing standardization with space for informal discussion |

**Related Terms**: [Agile](#agile), [CMS](./tools-techniques/documentation-specific.mdx#cms), [diagrams-as-code](#diagrams-as-code), [docs-as-ecosystem](frameworks-strategy.mdx#docs-as-ecosystem),
[docs observability](frameworks-strategy.mdx#docs-observability), [documentation audit](#documentation-audit), [Git](./tools-techniques/development-essentials.mdx#git),
[GitHub](./tools-techniques/development-essentials.mdx#github), [`main` branch](./tools-techniques/development-essentials.mdx#main-branch), [MDX](./tools-techniques/documentation-specific.mdx#mdx),
[metaprogramming](ai-and-apis.mdx#metaprogramming), [pull request](./tools-techniques/development-essentials.mdx#pull-request), [self-healing system](frameworks-strategy.mdx#self-healing-system),
[version control](./tools-techniques/development-essentials.mdx#version-control)
...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-docs-as-tests-workflow.png" 
  alt="Flowchart showing docs-as-tests workflow: writers maintain docs accuracy, implement tests, API changes, tests fail, tests alert writers, writers catch discrepancies"
/>

**Related Terms**: [AI agent](ai-and-apis.mdx#ai-agent), [API documentation testing](#api-documentation-testing), [BDD](#bdd),
[contract testing](#contract-testing), [deterministic testing](#deterministic-testing), [Doc Detective](./tools-techniques/testing-validation.md#doc-detective),
[docs observability](frameworks-strategy.mdx#docs-observability), [docs theater](writing-style.mdx#docs-theater), [documentation audit](#documentation-audit),
[eval](ai-and-apis.mdx#eval), [probabilistic testing](#probabilistic-testing), [self-healing system](frameworks-strategy.mdx#self-healing-system),
[snippet testing](#snippet-testing), [usability testing](#usability-testing), [workflow testing](#workflow-testing)
...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-doc-dev-lifecycle-phases.png" 
  alt="Flowchart showing DDLC phases: analysis and planning, designing, content development, proofreading and editing, publishing, implementation, approval, maintenance"
/>

**Related Terms**: [Agile](#agile), [API documentation testing](#api-documentation-testing), [CI/CD pipeline](./tools-techniques/development-essentials.mdx#cicd-pipeline),
[project management methodology](#project-management-methodology), [Seven-Action Documentation Model](frameworks-strategy.mdx#seven-action-documentation-model),
...
**Definition**: structured review process that evaluates existing docs
for accuracy, relevance, quality, and completeness; results in a prioritized
list of content to update, consolidate, unpublish, or delete

**Purpose**: prevents docs debt from accumulating silently — outdated
or low-quality content erodes user trust and increases support load; audits give
docs teams a systematic way to make maintenance decisions based on evidence - 
traffic data, age, accuracy checks - rather than intuition; for API docs
specifically, audits surface outdated endpoint references, broken
code examples, and deprecated parameters before users encounter them

### docs audit vs content retention

_Both are acceptable; consistency matters more than the choice_ -

| | **Documentation Audit** | **Content Retention and Maintenance** |
| --- | --- | --- |
| **Framing** | Bounded, periodic review event | Ongoing, continuous practice |
| **Implies** | Episodic inspection | Sustained care |
| **Used By** | Practitioners preferring discrete milestones | Practitioners preferring lifecycle language |
| **Activities** | Overlapping — both cover review, update, unpublish, delete | Overlapping — both cover review, update, unpublish, delete |

**Example**: a lone technical writer pulls a list of the top ten most-viewed
API docs from their analytics platform; any doc that hasn't been reviewed in
the past six months gets flagged for review that month; separately, a link
checker runs daily to catch dead references, and articles with low traffic
after six months are tagged for deprecation and archived or fully deleted after
twelve months if no longer needed — making audit a continuous practice rather than
a once-a-year project

**Related Terms**: [content](writing-style.mdx#content), [content governance](frameworks-strategy.mdx#content-governance), [content strategy](frameworks-strategy.mdx#content-strategy),
[docs-as-code](#docs-as-code), [docs-as-tests](#docs-as-tests), [version control](./tools-techniques/development-essentials.mdx#version-control)

**Sources**:

- [Write the Docs Newsletter: "Strategies for successful documentation audits" - July 2025](https://www.writethedocs.org/blog/newsletter-july-2025/#strategies-for-successful-documentation-audits)
- Write the Docs Slack: #general thread on documentation audit practices, March 2026
...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-guerilla-usability-testing.png" 
  alt="Flowchart showing guerilla usability testing key characteristics and deliverables: low maintenance, ad hoc settings, tests that don't require deep knowledge, less accurate than formal testing; test plan, recordings, summary report, presentation"
/>
...
[information architecture](frameworks-strategy.mdx#information-architecture),
...
**Definition**: testing approach that may produce different results across runs for
the same inputs; outcomes vary due to non-deterministic elements such as
[LLM](ai-and-apis.mdx#large-language-model) inference, browser rendering, or model
sampling; requires multiple trials and result aggregation to produce a reliable signal

**Purpose**: enables evaluation of AI-generated content and agentic workflows where
outputs cannot be reduced to a single correct answer; probabilistic testing tools like
LLM-as-judge graders and browser-use agents can bootstrap docs test coverage quickly,
but require ensemble testing — running the same test multiple times and aggregating results —
to compensate for output variability; teams use probabilistic testing where deterministic
checks cannot capture nuance, such as evaluating tone, accuracy of a synthesis, or
instruction-following quality

**Why this belongs in `Workflows & Methodologies`**: describes a testing methodology applicable
across AI evaluation and docs workflows; probabilistic testing is not exclusive to AI — any test
relying on network conditions, rendering engines, or sampling introduces variability; the term
describes _how a type of test behaves_ rather than a specific AI concept, making it a methodology
classification; its relationship to deterministic testing and docs-as-tests workflows anchors it
here alongside those terms

### probabilistic vs deterministic

| | **Probabilistic Testing** | **Deterministic Testing** |
| --- | --- | --- |
| **Consistency** | Varies between runs | Identical results every run |
| **CI/CD Scaling** | Gets expensive fast | Cost-effective |
| **Bootstrap Speed** | Faster to start | Higher upfront investment |
| **Trust in Isolation** | Can't be trusted alone — requires ensemble testing | Reliable as a standalone signal |
| **Relationship** | Often used to _generate_ deterministic tests | Used for ongoing validation once established |

**Example**: a docs team evaluates whether an AI writing agent follows their style guide and accurately
summarizes API changes; because the agent's output varies between runs, the team uses an LLM-as-judge
grader with a rubric covering tone, accuracy, and completeness; they run each eval task three times and
treat two out of three passes as a passing result; over time they calibrate the LLM grader against human
review to confirm it grades consistently — then retire the probabilistic grader for any criteria they can
express as a deterministic [Vale](./tools-techniques/documentation-specific.mdx#vale) rule instead

**Related Terms**: [AI agent](ai-and-apis.mdx#ai-agent), [API documentation testing](#api-documentation-testing),
[deterministic testing](#deterministic-testing), [docs-as-tests](#docs-as-tests), [eval](ai-and-apis.mdx#eval),
[Large Language Model](ai-and-apis.mdx#large-language-model), [Vale](./tools-techniques/documentation-specific.mdx#vale)
...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-scrum-workflow.png" 
  alt="Flowchart showing Scrum key characteristics: iterative approach, scrum master clears obstacles, two-week sprints, daily team meetings"
/>
...
**Related Terms**: [accessibility](frameworks-strategy.mdx#accessibility), [AI-assisted usability analysis](ai-and-apis.mdx#ai-assisted-usability-analysis),
[API documentation testing](#api-documentation-testing), [curse of knowledge](writing-style.mdx#curse-of-knowledge), [docs-as-ecosystem](frameworks-strategy.mdx#docs-as-ecosystem),
[Document Development Life Cycle](#document-development-life-cycle), [docs observability](frameworks-strategy.mdx#docs-observability), [DX](frameworks-strategy.mdx#dx),
[guerrilla usability testing](#guerrilla-usability-testing), [information architecture](frameworks-strategy.mdx#information-architecture), [UX](frameworks-strategy.mdx#ux),
[workflow testing](#workflow-testing)
