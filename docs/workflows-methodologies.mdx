...
<ZoomImage 
  ...
  alt="Flowchart showing an API docs testing workflow including test implementation, running tests, endpoint changings, tests failing, tests alerting team to change docs"
/>
