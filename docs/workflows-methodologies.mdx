...
[Git](./tools-techniques/development-essentials.mdx#git), [GitHub](./tools-techniques/development-essentials.mdx#github),
[`main` branch](./tools-techniques/development-essentials.mdx#main-branch),
[MDX](./tools-techniques/documentation-specific.mdx#mdx), [metaprogramming](ai-and-apis.mdx#metaprogramming),
[pull request](./tools-techniques/development-essentials.mdx#pull-request),
[self-healing system](frameworks-strategy.mdx#self-healing-system),
[version control](./tools-techniques/development-essentials.mdx#version-control)
...
[docs theater](writing-style.mdx#docs-theater), [self-healing system](frameworks-strategy.mdx#self-healing-system),
