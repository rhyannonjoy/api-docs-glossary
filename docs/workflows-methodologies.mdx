...
**Related Terms**: [Agile](#agile),
[CMS](./tools-techniques/documentation-specific.mdx#cms),
[diagrams-as-code](#diagrams-as-code),
[docs-as-ecosystem](frameworks-strategy.mdx#docs-as-ecosystem),
[Git](./tools-techniques/development-essentials.mdx#git),
[GitHub](./tools-techniques/development-essentials.mdx#github),
[`main` branch](./tools-techniques/development-essentials.mdx#main-branch),
[MDX](./tools-techniques/documentation-specific.mdx#mdx),
[pull request](./tools-techniques/development-essentials.mdx#pull-request),
