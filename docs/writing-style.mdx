...
- [Fabrizio Ferri Benedetti: "When docs become performance art, everybody loses"](https://passo.uno/documentation-theater-everybody-loses/)
- [Fabrizio Ferri Benedetti: "Code wikis are documentation theater as a service"](https://passo.uno/ai-wikis-docs-teather-as-a-service/)
