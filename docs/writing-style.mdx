...
**Related Terms**: [AI-assisted documentation](ai-and-apis.mdx#ai-assisted-documentation),
[Clayton's Docs](#claytons-docs), [docs-as-code](workflows-methodologies.mdx#docs-as-code),
[docs-as-ecosystem](frameworks-strategy.mdx#docs-as-ecosystem), [docs-as-tests](workflows-methodologies.mdx#docs-as-tests),
[RFC](./tools-techniques/documentation-specific.mdx#rfc), [Seven-Action Documentation Model](frameworks-strategy.mdx#seven-action-documentation-model)
...
**Related Terms**: [agent configuration](ai-and-apis.mdx#agent-configuration), [curse of knowledge](#curse-of-knowledge),
[domain knowledge](frameworks-strategy.mdx#domain-knowledge), [information architecture](frameworks-strategy.mdx#information-architecture),
