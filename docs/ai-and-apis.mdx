...
**Related Terms**: [AI](#ai), [AI agent](#ai-agent), [genAI](#genai), [liquid content](#liquid-content),
[metaprogramming](#metaprogramming), [Natural Language Processing](#natural-language-processing),
[orchestration](#orchestration), [prompt engineering](#prompt-engineering), [RAG](#rag)
...
**Related Terms**: [AI agent](#ai-agent), [docs-as-tests](workflows-methodologies.mdx#docs-as-tests),
[Large Language Model](#large-language-model), [metaprogramming](#metaprogramming),
[MCP server](#mcp-server), [prompt engineering](#prompt-engineering)
