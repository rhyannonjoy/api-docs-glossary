...
1. Attach published annotated screenshot examples
2. Attach current glossary term entry for context
...
1. Attach current glossary term for context
2. Edit and execute the following:
