...
6. Run `typos` from the project root before submitting a pull request.
7. Test all changes locally before submitting a pull request:
...
8. Pull requests should be complete and self-contained. Don't submit
placeholder content or partial entries.
9. Ideally, pull requests should address an existing issue,
but this isn't required.
10. Don't submit pull requests with lint or Vale errors in
