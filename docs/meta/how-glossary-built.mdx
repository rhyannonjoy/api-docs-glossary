...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-glossary-dev-workflow.png" 
  alt="Glossary development workflow in the style of a flowchart"
/>
...
| **Standardization** | AI-assistance applies [Style Guide](style-guide.mdx) formatting | Consistent formatting and structure; appropriate capitalization rules; proper anchor link syntax; related term connections |
...
| Inconsistent capitalization | Review [Capitalization](style-guide.mdx#capitalization) section |
...
The [Style Guide](style-guide.mdx) documents standards as they emerge
...
The [Style Guide](style-guide.mdx) evolves to document new patterns, resolve edge
