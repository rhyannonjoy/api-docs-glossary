...
<ZoomImage 
  src="/api-docs-glossary/img/flowchart-introduction.png" 
  alt="What's your background? If new to APIs, review Core Concepts, AI and APIs; Tech Writers review Writing Style, Workflows and Methodologies; Devs review Tools and Techniques, Frameworks and Strategy; Students review Quick Reference"
/>
...
| Found an error or have a suggestion? | Visit the [Contribution Guide](../docs/meta/contribution-guide.mdx) |
