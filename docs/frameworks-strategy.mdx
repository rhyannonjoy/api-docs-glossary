...
**Related Terms**: [banner blindness](writing-style.mdx#banner-blindness), [content strategy](#content-strategy),
[diagrams-as-code](workflows-methodologies.mdx#diagrams-as-code), [docs-as-ecosystem](#docs-as-ecosystem), [DX](#dx),
[guerilla usability testing](workflows-methodologies.mdx#guerrilla-usability-testing), [information architecture](#information-architecture),
...
**Related terms**: [API](./core-concepts/api-fundamentals.mdx#api), [API reference topic](./core-concepts/documentation-specific.mdx#api-reference-topic),
[curse of knowledge](writing-style.mdx#curse-of-knowledge), [Diátaxis](#diátaxis), [DX](#dx), [end-user software engineer](#end-user-software-engineer),
[usability testing](workflows-methodologies.mdx#usability-testing), [UX](#ux)
...
**Related Terms**: [content](writing-style.mdx#content), [content strategy](#content-strategy), [docs-as-code](workflows-methodologies.mdx#docs-as-code), [docs-as-tests](workflows-methodologies.mdx#docs-as-tests),
[documentation audit](workflows-methodologies.mdx#documentation-audit), [information architecture](#information-architecture), [knowledge management](#knowledge-management), [tone](writing-style.mdx#tone)
...
**Related Terms**: [accessibility](#accessibility), [content](writing-style.mdx#content), [content governance](#content-governance), [curse of knowledge](writing-style.mdx#curse-of-knowledge),
[docs-as-ecosystem](#docs-as-ecosystem), [documentation audit](workflows-methodologies.mdx#documentation-audit), [information architecture](#information-architecture),
[knowledge management](#knowledge-management), [market](#market), [ontology](#ontology), [sales collateral](#sales-collateral), [technical communication](#technical-communication)
...
than an ancillary element, enabling tech writers to move from defensive
output metrics — pages published, tickets closed — toward infrastructure
and product metrics that reflect docs' role in org success; examples of
what this framing makes measurable:
...
- _Did reading a doc correlate with a decrease in support tickets for that feature?_
- _Did documented processes show a higher success or conversion rate?_

**Treating docs as observable infrastructure means measuring docs the same way
infrastructure performance is measured**: by the efficiency of the processes that
rely on it and the incidents avoided by maintaining it; treating docs as a product
means applying product engagement metrics — returning users, satisfaction scores,
feature adoption — rather than isolated content metrics
...
- [Docs By Design: "Why I'm passionate about content metrics" by Bob Watson](https://docsbydesign.com/2018/01/11/why-im-passionate-about-content-metrics/)
- [passo.uno: "Docs observability, or measuring docs inside a product-docs system" by Fabrizio Ferri Benedetti](https://passo.uno/docs-observability-do11y/)
- [passo.uno: "Measure it till you make it" by Fabrizio Ferri Benedetti](https://passo.uno/tech-writing-metricks-kpis/)
...
**Related Terms**: [API](./core-concepts/api-fundamentals.mdx#api), [curse of knowledge](writing-style.mdx#curse-of-knowledge),
[Diátaxis](#diátaxis), [docs-as-ecosystem](#docs-as-ecosystem), [DSL](./tools-techniques/diagramming-visualization.mdx#dsl), [end-user software engineer](#end-user-software-engineer),
[information architecture](#information-architecture), [knowledge management](#knowledge-management), [ontology](#ontology), [progressive disclosure](writing-style.mdx#progressive-disclosure),
[RAG](ai-and-apis.mdx#rag), [taxonomy](#taxonomy), [technical communication](#technical-communication)
...
[API sandbox](./tools-techniques/documentation-specific.mdx#api-sandbox), [banner blindness](writing-style.mdx#banner-blindness),
[cognitive dimensions of API usability](#cognitive-dimensions-of-api-usability), [CTA](writing-style.mdx#cta), [curse of knowledge](writing-style.mdx#curse-of-knowledge),
[developer portal](./tools-techniques/documentation-specific.mdx#developer-portal), [docs observability](#docs-observability), [end-user software engineer](#end-user-software-engineer),
[error handling](./core-concepts/api-fundamentals.mdx#error-handling), [getting started](./core-concepts/documentation-specific.mdx#getting-started),
[SDK](./core-concepts/api-fundamentals.mdx#sdk), [Seven-Action Documentation Model](#seven-action-documentation-model), [usability testing](workflows-methodologies.mdx#usability-testing), [UX](#ux)
...
**Related Terms**: [accessibility](#accessibility), [CCMS](./tools-techniques/documentation-specific.mdx#ccms),
[content](writing-style.mdx#content), [content governance](#content-governance),
...
**Related Terms**: [CCMS](./tools-techniques/documentation-specific.mdx#ccms),
[CMS](./tools-techniques/documentation-specific.mdx#cms), [content governance](#content-governance),
[content strategy](#content-strategy), [curse of knowledge](writing-style.mdx#curse-of-knowledge), [DAM](./tools-techniques/documentation-specific.mdx#dam),
[docs-as-code](./workflows-methodologies.mdx#docs-as-code), [docs-as-ecosystem](#docs-as-ecosystem), [domain knowledge](#domain-knowledge),
[information architecture](#information-architecture), [market](#market), [metadata](./tools-techniques/documentation-specific.mdx#metadata),
[ontology](#ontology), [progressive disclosure](writing-style.mdx#progressive-disclosure), [sales collateral](#sales-collateral),
...
and ROI, _return on investment_, narratives that sales teams and prospects
...
**Related Terms**: [banner blindness](writing-style.mdx#banner-blindness), [CTA](writing-style.mdx#cta),
[docs observability](#docs-observability), [docs theater](writing-style.mdx#docs-theater),
[Document Development Life Cycle](workflows-methodologies.mdx#document-development-life-cycle), [docs-as-ecosystem](#docs-as-ecosystem),
[DX](#dx), [information architecture](#information-architecture), [UX](#ux)
...
[banner blindness](writing-style.mdx#banner-blindness), [cognitive dimensions of API usability](#cognitive-dimensions-of-api-usability), [CTA](writing-style.mdx#cta),
[curse of knowledge](writing-style.mdx#curse-of-knowledge), [docs observability](#docs-observability), [DX](#dx), [end-user software engineer](#end-user-software-engineer),
[guerilla usability testing](workflows-methodologies.mdx#guerrilla-usability-testing), [information architecture](#information-architecture),
[Seven-Action Documentation Model](#seven-action-documentation-model), [usability testing](workflows-methodologies.mdx#usability-testing)
