...
[cognitive dimensions of API usability](#cognitive-dimensions-of-api-usability), [curse of knowledge](writing-style.mdx#curse-of-knowledge), [developer portal](./tools-techniques/documentation-specific.mdx#developer-portal), [docs observability](#docs-observability),
[end-user software engineer](#end-user-software-engineer), [error handling](./core-concepts/api-fundamentals.mdx#error-handling), [getting started](./core-concepts/documentation-specific.mdx#getting-started),
...
**Related Terms**: [banner blindness](writing-style.mdx#banner-blindness), [docs observability](#docs-observability), [docs theater](writing-style.mdx#docs-theater),
...
[banner blindness](writing-style.mdx#banner-blindness), [cognitive dimensions of API usability](#cognitive-dimensions-of-api-usability),
