...
| Scenario | Start here |
| -------------- | ------------ |
| **New to API documentation** | [API](./core-concepts/api-fundamentals.mdx#api) → [REST API](api-types-architectures.md#rest-api) → [API reference topic](./core-concepts/documentation-specific.md#api-reference-topic) |
| **Learning OpenAPI Specification** | [OpenAPI Specification](./core-concepts/documentation-specific.md#openapi-specification) → [JSON](./core-concepts/api-fundamentals.mdx#json) → [YAML](./tools-techniques/development-essentials.md#yaml) |
...
| **Working on an API tutorial** | [API overview topic](./core-concepts/documentation-specific.md#api-overview-topic) → [market](./frameworks-strategy.md#market) → [rhetorical approach](./writing-style.md#rhetorical-approach) |
